      ...
      <div class="col-md-12">
        <form class="form-horizontal" method="POST" action="{{ url('/product') }}" enctype="multipart/form-data">
          ...
          <div class="form-group {{ $errors->has('price') ? ' has-error' : '' }}">
            ...
            <div class="col-sm-6">
              <input type="text" class="form-control" name="price" value="{{ old('price') }}" autofocus id="price" placeholder="Price">
              @if ($errors->has('price'))
                  <span class="help-block">
          ...
          <div class="form-group {{ $errors->has('description') ? ' has-error' : '' }}">
            ...
            <div class="col-sm-6">
              <input type="text" class="form-control" name="description" value="{{ old('description') }}" autofocus id="description" placeholder="Description">
